...
export class MultiMerkleStash extends ethereum.SmartContract {
  static bind(address: Address): MultiMerkleStash {
    return new MultiMerkleStash("MultiMerkleStash", address);
  }
