...
export class MultiMerkleStashCVX extends ethereum.SmartContract {
  static bind(address: Address): MultiMerkleStashCVX {
    return new MultiMerkleStashCVX("MultiMerkleStashCVX", address);
  }
